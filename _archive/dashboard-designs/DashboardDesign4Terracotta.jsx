// Dashboard Design Proposition #4c: Cards Immersives Magazine - VARIANTE FOND TERRACOTTA
// Ambiance chaleureuse terreuse avec fond ocre/terracotta
...
export default function DashboardDesign4Terracotta({ user, onSignOut, onStartAudit }) {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#C96442' }}>
      
      {/* Header avec effet glassmorphism sur fond terracotta */}
      <header 
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-lg text-white" style={{ fontFamily: "'EB Garamond', Georgia, serif" }}>
              Re-Boot
            </span>
          </div>
          
          <nav className="flex items-center gap-1 bg-white/15 rounded-full p-1">
            {[
              ...
              <button
                ...
                style={{
                  ...
                  color: activeTab === tab.id ? '#C96442' : 'rgba(255,255,255,0.9)'
                }}
              >
                {tab.label}
              </button>
      ...
      <main className="pt-24 pb-12 px-6 max-w-7xl mx-auto">
        ...
        {activeTab === 'overview' && (
          <>
            ...
            <section className="mb-12">
              <div className="grid grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <h1 className="text-5xl mb-4 leading-tight text-white" style={{ fontFamily: "'EB Garamond', Georgia, serif" }}>
                    Cartographie ton <br/>
                    <span className="text-white/90">fonctionnement</span> cognitif
                  </h1>
                  ...
                  {session && (
                    <div className="flex items-center gap-6">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-xs text-white/60">Audits complétés</p>
                      </div>
                      <div className="w-px h-12 bg-white/30" />
                      <div className="text-center">
                        <p className="text-4xl font-bold text-white">
            ...
            <section>
              <h2 className="text-2xl mb-6 text-white" style={{ fontFamily: "'EB Garamond', Georgia, serif" }}>
                Les 4 audits
              </h2>
                ...
                {TEST_CARDS.map((test, index) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ 
                        height: '320px',
                        background: isLocked ? 'rgba(0,0,0,0.2)' : test.gradient,
                        boxShadow: isLocked ? 'none' : '0 10px 40px rgba(0,0,0,0.2)'
                      }}
                      ...
                      <div className="relative z-10 p-8 h-full flex flex-col justify-between">
                        <div>
                          <div className="flex items-center justify-between mb-4">
                            ...
                            {status === 'completed' && (
                              <span className="px-3 py-1 rounded-full text-xs font-medium bg-white/30 text-white">
                                ✓ Complété
                              </span>
                            )}
                            {isLocked && (
                              <span className="px-3 py-1 rounded-full text-xs font-medium bg-black/30 text-white/80">
                                🔒 Verrouillé
                              </span>
                            )}
                          </div>
            ...
            <section className="mt-12 text-center">
              ...
              >
                <p className="text-white/80 mb-4">Des questions sur tes résultats ?</p>
                <button className="px-8 py-4 rounded-full font-medium text-[#C96442] bg-white hover:bg-white/90 transition-colors">
        ...
        {activeTab === 'audits' && (
          <div className="text-center py-20">
            <p className="text-white/60 text-xl">Historique complet de tes audits</p>
            <p className="text-white/40 mt-2">Intégrer DashboardAudits ici</p>
          </div>
        )}

        {activeTab === 'profile' && (
          <div className="text-center py-20">
            <p className="text-white/60 text-xl">Profil cognitif détaillé</p>
            <p className="text-white/40 mt-2">Intégrer DashboardProfile ici</p>
          </div>
        )}
      </main>
    </div>

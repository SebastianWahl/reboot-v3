...
const ALL_TESTS = [
  { id: '4-registres', label: '4 Registres', icon: '🧭', color: '#C96442', max: 100 },
  { id: 'instinctif',  label: 'Instinctif',  icon: '🫀', color: '#c0392b', max: 60  },
  { id: 'emotionnel',  label: 'Émotionnel',  icon: '💞', color: '#e6a817', max: 60  },
  { id: 'mental',      label: 'Mental',      icon: '🧠', color: '#2980b9', max: 60  },
];
...
// ─── KPI Tile avec Cercle / Dial (Style 1) ───────────────────────────────────
function KpiTile({ test, score, niveau, isDemo }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-20 h-20 mb-3">
        ...
        {/* Score au centre - NORMALISÉ SUR 100 */}
    ...
    <div className="w-full space-y-5">
      ...
      <div className="grid grid-cols-4 gap-4">
        {kpiData.map(({ test, score, niveau, isDemo: d }) => (
          <KpiTile key={test.id} test={test} score={score} niveau={niveau} isDemo={d} />
        ))}
      </div>
